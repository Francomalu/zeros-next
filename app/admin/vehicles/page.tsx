...
export default function VehicleManagement() {
  ...
  const handleAddVehicle = () => {
    ...
    addForm.setForm(initialVehicleForm);
    loadAllOptions();
  };
    ...
    <div className="space-y-6">
      ...
      >
        <FormField label="Tipo">
          <ApiSelect
            value={String(addForm.state.data.vehicleTypeId)}
            onValueChange={(value) =>
        ...
        <FormField label="Capacidad disponible">
          <Input
            id="availableQuantity"
            placeholder="Cantidad disponible"
            value={addForm.state.data.availableQuantity}
        ...
        <FormField label="Interno">
          <Input
            ...
            value={addForm.state.data.internalNumber}
      ...
      >
        <FormField label="Tipo">
          <ApiSelect
            value={String(editForm.state.data.vehicleTypeId)}
            onValueChange={(value) => {
              handleSetVehicleType(value, vehicleTypes.find((type) => type.id === value)?.defaultQuantity);
            }}
            placeholder="Seleccionar tipo"
        ...
        <FormField label="Capacidad disponible">
          <Input
            id="availableQuantity"
            placeholder="Cantidad disponible"
            value={editForm.state.data.availableQuantity}
        ...
        <FormField label="Numero de Interno">
          <Input
            ...
            value={editForm.state.data.internalNumber}
