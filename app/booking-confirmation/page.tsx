...
import { CheckCircle, Bus, Calendar, Clock, MapPin, Download, ChevronLeft } from "lucide-react"
...
export default function BookingConfirmationPage() {
  ...
  useEffect(() => {
    ...
    const randomBookingNumber = `FT-${Math.floor(100000 + Math.random() * 900000)}`
        ...
        <Card className="w-full max-w-md">
          <CardContent className="p-6 text-center">
            ...
            <p className="text-gray-600 mb-6">
              There was an issue processing your booking. Please try again or contact customer support.
            </p>
            <div className="flex flex-col gap-2">
              <Link href="/results">
                <Button className="w-full bg-blue-600 hover:bg-blue-700">Return to Search Results</Button>
              </Link>
              <Link href="/">
        ...
        <div className="max-w-3xl mx-auto">
          ...
          <Card className="border-green-100 shadow-lg overflow-hidden">
            <div className="bg-green-50 p-6 border-b border-green-100 text-center">
              ...
              <h1 className="text-2xl md:text-3xl font-bold text-green-800 font-display">Booking Confirmed!</h1>
              <p className="text-green-700 mt-2">
                Your trip has been successfully booked. We've sent a confirmation email with all the details.
              </p>
            </div>
            <CardContent className="p-6">
              <div className="bg-blue-50 p-4 rounded-lg mb-6">
                <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-2">
                  <div>
                    ...
                    <div className="text-xl font-bold text-blue-800">{bookingNumber}</div>
                  </div>
              ...
              <div className="space-y-6">
                <div>
                  <h2 className="text-lg font-bold text-gray-900 mb-3">Trip Details</h2>
                    ...
                    <div className="bg-gray-50 p-4 rounded-lg">
                      <div className="flex items-start gap-3">
                        ...
                        <div>
                          ...
                          <div className="font-medium">Monday, April 15, 2024</div>
                        </div>
                      </div>
                    </div>
                    <div className="bg-gray-50 p-4 rounded-lg">
                ...
                <div>
                  ...
                  <div className="bg-yellow-50 p-4 rounded-lg text-sm space-y-2">
                    <p>
                      <span className="font-medium">Check-in:</span> Please arrive at least 15 minutes before departure.
                    </p>
                    <p>
                      <span className="font-medium">Luggage:</span> Each passenger is allowed one piece of luggage (max
                      20kg) and one carry-on item.
                    </p>
                    <p>
                      <span className="font-medium">Cancellation:</span> Free cancellation up to 24 hours before
                      departure. A 50% fee applies for cancellations made less than 24 hours before departure.
                    </p>
                  </div>
                </div>
          ...
          <div className="mt-8 text-center">
            <h2 className="text-lg font-bold text-gray-900 mb-2">Need Assistance?</h2>
