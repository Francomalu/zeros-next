...
export const AnimatedSection = forwardRef<HTMLElement, AnimatedSectionProps>(
  (
    { animation = "fade-up", delay = 0, threshold = 0.1, as = "section", className, children, ...props },
    forwardedRef,
  ) => {
    ...
    return (
      <Component
        ...
        className={cn(animationClasses[animation], isIntersecting && activeClasses[animation], className)}
        style={{
