        ...
        <div className="grid md:grid-cols-2 gap-8 items-center">
          ...
          <div className="text-white">
            ...
            <p className="mt-4 text-lg md:text-xl">
              Providing reliable and comfortable short-distance transportation for over 25 years. Where every passenger
          ...
          <div>
            <Card className="border-blue-100 shadow-lg bg-white/95 backdrop-blur-sm">
              <CardContent className="p-4">
                <h2 className="text-xl font-bold text-blue-800 mb-4 font-display">Find Your Trip</h2>
                <form onSubmit={handleSearch} className="space-y-3">
                  <div className="space-y-3">
                    <div className="space-y-2">
                      <label className="text-sm font-medium text-blue-900">Trip Type</label>
                      <RadioGroup
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                      <div className="space-y-2">
                        <label className="text-sm font-medium text-blue-900">Departure Date</label>
                        <Popover>
                      ...
                      {tripType === "round-trip" && (
                        <div className="space-y-2">
                          <label className="text-sm font-medium text-blue-900">Return Date</label>
                          <Popover>
                            <PopoverTrigger asChild>
                              <Button
                                variant="outline"
                    ...
                    <div className="space-y-2">
                      <label className="text-sm font-medium text-blue-900">Passengers</label>
